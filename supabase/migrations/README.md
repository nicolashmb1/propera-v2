...
| **019_properties_program_expansion_profile.sql** | `properties.program_expansion_profile` (jsonb) — per-property PM expansion hints | **`expandProgramLines.js`** (`floor_paint_scopes`, `common_paint_scopes`) — see **`docs/PM_PROGRAM_ENGINE_V1.md`** |
