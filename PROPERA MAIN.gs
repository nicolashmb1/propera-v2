  ...
  ************************************/
  ...
  function handleSmsRouter_(e) {
    ...
    const media = mediaUrls.map(function(url, idx) {
      return {
        url: url,
        contentType: String(mediaTypes[idx] || "")
      };
    });
    ...
    const scopeChannel = String(inbound.channel || channel || "").toUpperCase();
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          if (fromKey) {
            var _ogCrashChannel = (typeof globalThis !== "undefined" && globalThis.__inboundChannel) ? String(globalThis.__inboundChannel).trim().toUpperCase() : "SMS";
  ...
  function normalizeInboundEvent_(source, opts) {
    ...
    // normalize media into a stable array of { url, contentType }
    let media = [];
    try {
      if (Array.isArray(O.media)) {
        media = O.media.map(function(m) {
          return {
            url: String(m && m.url || ""),
            contentType: String(m && m.contentType || "")
          };
        }).filter(function(m) {
          return m.url;
        });
  ...
  *******************************************************/
  ...
  // Actor key normalization:
  // - For prefixed synthetic IDs (SCAP:, TG:, APP:), keep as-is.
  // - Otherwise, fall back to phoneKey_().
  ...
  * @param {Object} [opts] - Optional: { channel: "SMS"|"WA"|"TELEGRAM", deliveryPolicy: "DIRECT_SEND"|"NO_HEADER" }. When omitted, current behavior (welcome + compliance per allowlists).
  *   - channel "WA" or "TELEGRAM": do not append compliance footer (SMS-only).
  ...
  */
  ...
  function finishEmergencyIfReady_(sheet, dir, dirRow, row, lang) {
    ...
    if (hasProp && hasUnit && hasMsg) {
      ...
      if (tid) {
        var _ogEChannel = (typeof globalThis !== "undefined" && globalThis.__inboundChannel) ? String(globalThis.__inboundChannel).trim().toUpperCase() : "SMS";
  ...
  function handleSmsSafe_(e) {
    ...
    try {
      ...
      try {
        ...
        var _ogErrChannel = (typeof globalThis !== "undefined" && globalThis.__inboundChannel) ? String(globalThis.__inboundChannel).trim().toUpperCase() : "SMS";
  ...
  */
  ...
  function handleSmsCore_(e) {
    ...
    try {
      ...
      const channel = String((e && e.parameter && e.parameter._channel) ||
                             (typeof globalThis !== "undefined" && globalThis.__inboundChannel) ||
                             "SMS").toUpperCase();
  ...
  if (mode === "TENANT" && dirRow > 0 && domainDecision && domainDecision.detectedDomain === OPS_DOMAIN.CLEANING &&
    ...
    try {
      ...
      if (earlyResult && earlyResult.handled) {
        ...
        try { var _ogC0 = (typeof dispatchOutboundIntent_ === "function") ? dispatchOutboundIntent_({ intentType: "CLEANING_WORKITEM_ACK", recipientType: "TENANT", recipientRef: phone, lang: lang, channel: _channel, deliveryPolicy: "NO_HEADER", vars: baseVars || {}, meta: { source: "HANDLE_SMS_CORE", stage: "CLEANING_EARLY", flow: "MAINTENANCE_INTAKE" } }) : { ok: false }; if (!(_ogC0 && _ogC0.ok)) replyNoHeader_(renderTenantKey_("CLEANING_WORKITEM_ACK", lang, baseVars)); } catch (_) {}
        return;
      }
    } catch (_) {}
  }
    ...
    if (!conversational[nextUp]) {
      ...
      if (effectiveStage === "UNIT") {
        ...
        if (cap && cap.hasProp) {
          ...
          var _og = (typeof dispatchOutboundIntent_ === "function") ? dispatchOutboundIntent_({ intentType: "ASK_FOR_MISSING_UNIT", recipientType: "TENANT", recipientRef: phone, lang: lang, channel: _channel, deliveryPolicy: "DIRECT_SEND", vars: v || {}, meta: { source: "HANDLE_SMS_CORE", stage: "UNIT", flow: "MAINTENANCE_INTAKE" } }) : { ok: false };
        ...
        var _og2 = (typeof dispatchOutboundIntent_ === "function") ? dispatchOutboundIntent_({ intentType: "ASK_FOR_MISSING_UNIT", recipientType: "TENANT", recipientRef: phone, lang: lang, channel: _channel, deliveryPolicy: "DIRECT_SEND", vars: baseVars || {}, meta: { source: "HANDLE_SMS_CORE", stage: "UNIT", flow: "MAINTENANCE_INTAKE" } }) : { ok: false };
  ...
  function reply_(text) {
    ...
    try {
      ...
      try {
        ...
        if (typeof logDevSms_ === "function") {
          try { logDevSms_(phone, "", "OUTBOUND_DIRECT_SEND eid=[" + eid + "] source=[reply_] channel=[" + String(ch || "") + "]"); } catch (_) {}
        }
      } catch (_) {}
  ...
  function replyNoHeader_(text) {
    ...
    try {
      ...
      try {
        var eid = (typeof globalThis !== "undefined" && globalThis.__properaTurnEid) ? String(globalThis.__properaTurnEid) : "";
        if (typeof logDevSms_ === "function") {
          try { logDevSms_(phone, "", "OUTBOUND_DIRECT_SEND eid=[" + eid + "] source=[replyNoHeader_] channel=[" + String(ch || "") + "]"); } catch (_) {}
        }
      } catch (_) {}
      if (ch === "WA") {
        sendWhatsApp_(TWILIO_SID, TWILIO_TOKEN, TWILIO_WA_FROM, phone, msg);
    ...
    if (modeNow === "TENANT" && dirRow > 0 && !stageNow2 && effStageUp !== "SCHEDULE") {
      ...
      if (effStageUp && draftStages.indexOf(effStageUp) >= 0) {
        ...
        if ((isGreeting || isAck || !actionable) && !hasDraftData) {
          var _ogH = (typeof dispatchOutboundIntent_ === "function") ? dispatchOutboundIntent_({ intentType: "SHOW_HELP", recipientType: "TENANT", recipientRef: phone, lang: lang, channel: _channel, deliveryPolicy: "NO_HEADER", vars: baseVars || {}, meta: { source: "HANDLE_SMS_CORE", stage: "CONFIRM_GATE", flow: "MAINTENANCE_INTAKE" } }) : { ok: false };
  ...
  if (mode === "TENANT" && !createdByManager && tenantMatch && dirRow > 0 && !stageNow) {
    ...
    if (looksLikeGreetingOnly_(msgLower0) || looksLikeAckOnly_(msgLower0)) {
      var _ogH2 = (typeof dispatchOutboundIntent_ === "function") ? dispatchOutboundIntent_({ intentType: "SHOW_HELP", recipientType: "TENANT", recipientRef: phone, lang: lang, channel: _channel, deliveryPolicy: "NO_HEADER", vars: baseVars || {}, meta: { source: "HANDLE_SMS_CORE", stage: "TENANT_DB_GATE", flow: "MAINTENANCE_INTAKE" } }) : { ok: false };
